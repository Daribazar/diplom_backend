...
async def test_course_crud():
    ...
    async with httpx.AsyncClient() as client:
        ...
        # Login
        login_data = {"email": "course_test@example.com", "password": "testpassword123"}
        ...
        response = await client.post(
            f"{BASE_URL}/api/v1/courses", json=course_data, headers=headers
        )
        ...
        response = await client.get(f"{BASE_URL}/api/v1/courses", headers=headers)
        ...
        response = await client.get(
            f"{BASE_URL}/api/v1/courses/{course_id}", headers=headers
        )
        ...
        response = await client.patch(
            f"{BASE_URL}/api/v1/courses/{course_id}", json=update_data, headers=headers
        )
        ...
        response = await client.get(
            f"{BASE_URL}/api/v1/courses/{course_id}", headers=invalid_headers
        )
