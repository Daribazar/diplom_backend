...
from src.3_domain.interfaces.storage_service import IStorageService
...
class UploadLectureUseCase:
    ...
    async def execute(
        ...
        from src.4_infrastructure.queue.tasks.lecture_processing import process_lecture_task
