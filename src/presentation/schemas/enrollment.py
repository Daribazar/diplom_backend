...
class EnrollmentResponse(BaseModel):
    ...
    status: EnrollmentStatus = Field(..., description="Enrollment status: pending, approved, rejected")
...
class CourseWithEnrollmentStatus(BaseModel):
    ...
    instructor: str
    color: str
    enrollment_status: Optional[EnrollmentStatus] = Field(None, description="pending, approved, rejected, or None if not enrolled")
